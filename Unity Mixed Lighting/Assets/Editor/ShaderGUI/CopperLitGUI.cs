...
public class CopperLitShader : BaseShaderGUI
{
    private LitGUI.LitProperties litProperties;

    public static readonly GUIContent checkerText = new GUIContent("Checker On",
                "Checker.");
    ...
    public override void DrawSurfaceOptions(Material material)
    {
        ...
        //TODO: vanCopper
        EditorGUI.BeginChangeCheck();
        var checkerOn = EditorGUILayout.Toggle(checkerText, checkerProperty.floatValue == 1.0f);
        if (EditorGUI.EndChangeCheck())
            checkerProperty.floatValue = checkerOn ? 1.0f : 0.0f;
        base.DrawSurfaceOptions(material);
    }


    protected MaterialProperty checkerProperty;
    public override void OnGUI(MaterialEditor materialEditorIn, MaterialProperty[] properties)
    {

        checkerProperty = FindProperty("_CHECKER_ON", properties, false);
